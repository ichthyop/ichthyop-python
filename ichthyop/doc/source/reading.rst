...
.. literalinclude:: examples/read_dataset.py
...
.. ipython:: python
    ...
    fpath = "source/examples/read_dataset.py"
...
.. literalinclude:: examples/extract_date.py
...
.. ipython:: python
    ...
    fpath = "source/examples/extract_date.py"
    with open(fpath) as f:
        code = compile(f.read(), fpath, 'exec')
        exec(code)
