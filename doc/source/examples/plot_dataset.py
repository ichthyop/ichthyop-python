...
plt.title('No col.')
plt.savefig('source/_static/map1.png', bbox_inches='tight')
plt.close(fig)
...
plt.title('Drifter')
plt.savefig('source/_static/map2.png', bbox_inches='tight')
...
plt.savefig('source/_static/map3.png', bbox_inches='tight')
plt.close(fig)
